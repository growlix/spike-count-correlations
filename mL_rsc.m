function [r, p, pair] = mL_rsc(rates,varargin)

% Computes spike count correlations (rsc) between pairs of neurons. Spike
% count correlations are correlations in the variability of two neurons'
...
for classI = 1:nClasses
   ...
   rates(currClassInds,:) = (currClassRates - ...
       nanmean(currClassRates))./nanstd(currClassRates) ;
end

% Compute pearson's correlation
[r, p] = corrcoef(rates,'rows','pairwise') ;
